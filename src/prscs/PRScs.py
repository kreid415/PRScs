...
from prscs import parse_genet
from prscs import mcmc_gtb
    ...
    if len(sys.argv) > 1:
        ...
        for opt, arg in opts:
            if opt == "-h" or opt == "--help":
                ...
                param_dict["beta_std"] = arg.upper()
            elif opt == "--write_psi":
                param_dict["write_psi"] = arg.upper()
            elif opt == "--write_pst":
...
def main():
    ...
    for chrom in param_dict["chrom"]:
        ...
        mcmc_gtb.mcmc(
            ...
            param_dict["out_dir"],
            param_dict["beta_std"],
            param_dict["write_psi"],
            param_dict["write_pst"],
            param_dict["seed"],
        )
